...
//        TreeNode root = ConstructTree.constructTree(new Integer[]{1, 2, 3, 4, 5, 6, 7});
        TreeNode root = ConstructTree.constructTree(new Integer[]{1, null, 2, 2, 32, 31, 3, 23, 1, 23, 123, 12, 3, 12, 31, 23, 2});
//        TreeNode root = ConstructTree.constructTree(new Integer[]{1,null,2,3});
        // 将刚刚创建的树打印出来
        TreeOperation.show(root);

//        TreeOperation.show(ConstructTree.constructTree(new Integer[]{1,2}));
    }
