...
public class Blip3 implements Externalizable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Print.print(b3);
        ObjectOutputStream o = new ObjectOutputStream(new FileOutputStream(thinkjava.JavaIo.Utils.Constants.writePathU + "Blip3.out"));
        Print.print("Saving object:");
        o.writeObject(b3);
        o.close();

        //Now get it back:
        ObjectInputStream in = new ObjectInputStream(new FileInputStream(thinkjava.JavaIo.Utils.Constants.writePathU + "Blip3.out"));
