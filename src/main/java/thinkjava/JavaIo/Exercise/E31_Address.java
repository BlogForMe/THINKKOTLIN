...
import static thinkjava.JavaIo.Exercise.Person1.format;
...
public class E31_Address {
    public static void main(String[] args) throws Exception {
        ...
        format(new BufferedOutputStream(new FileOutputStream(thinkjava.JavaIo.Utils.Constants.writePathU + "People.xml")), doc);
    }
}
