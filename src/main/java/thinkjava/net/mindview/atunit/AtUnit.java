//: thinkjava.net/mindview/atunit/AtUnit.java
// An annotation-based unit-thinkjava.test framework.
// {RunByHand}
...
import static thinkjava.net.mindview.util.Print.*;
    ...
    if(creator != null) {
      ...
      try {
        ...
        throw new RuntimeException("Couldn't create a " +
          "thinkjava.test object. Try using a @TestObject method.");
      }
    }
  }
} ///:~
